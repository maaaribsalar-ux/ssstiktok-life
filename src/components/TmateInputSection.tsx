    ...
    <div class="max-w-6xl mx-auto mt-8 px-4">
      ...
      <div class="max-w-6xl mx-auto">
        <div class="download-box rounded-2xl">
          <div class="bg-sky-500 rounded backdrop-blur-md p-2">
            ...
            >
              <div class="relative flex-grow rounded bg-white">
                <input type="text"
                  ...
                  class="w-full h-14 text-black rounded px-5 pr-20 transition-all duration-300"
                />
                <button type="button" 
                  onClick={handlePaste} 
              ...
              <button type="submit" 
                ...
                class="h-14 px-8 bg-sky-500 hover:from-sky-500 text-white font-medium rounded transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed">
                {loading() ? (
                  <>
