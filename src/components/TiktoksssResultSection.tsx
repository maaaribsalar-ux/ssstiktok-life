        ...
        <div class="bg-white rounded overflow-hidden backdrop-blur-sm border border-white/10 p-4">
          <div class="flex flex-col md:flex-row gap-4">
            <div class="md:w-1/3 flex-shrink-0">
              <div class="relative rounded overflow-hidden max-h-[430px]">
                {getVideoUrl() && (
                  <video 
                    controls 
                    src={getVideoUrl()} 
            ...
            <div class="md:w-2/3 flex flex-col justify-between">
              ...
              <div class="space-y-2">
                {data?.result?.videoSD && (
                  <button class="download-button bg-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-900 w-full p-3 rounded text-white flex items-center justify-center">
                ...
                {data?.result?.videoWatermark && (
                  <button class="download-button bg-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-900 hover:to-green-300 w-full p-3 rounded text-white flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {data?.result?.music && (
                  <button class="download-button bg-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-900 hover:to-yellow-300 w-full p-3 rounded text-white flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"></path>
                    </svg> 
                ...
                <button 
                  onClick={onReset}
                  class="download-button bg-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-900 w-full p-3 rounded text-white flex items-center justify-center">
