        ...
        <div class="bg-white rounded overflow-hidden backdrop-blur-sm border border-white/10 p-4">
          <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="md:w-2/3 flex flex-col justify-between">
              ...
              <div class="space-y-2">
                {data?.result?.videoSD && (
                  <button class="download-button bg-blue-600 hover:to-blue-600 w-full p-3 rounded text-white flex items-center justify-center">
                ...
                <button 
                  onClick={onReset}
                  class="download-button bg-blue-600 hover:to-blue-600 w-full p-3 rounded text-white flex items-center justify-center">
