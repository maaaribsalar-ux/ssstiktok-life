    ...
    <div class="max-w-6xl mx-auto mt-8 px-4">
      ...
      <div class="max-w-6xl mx-auto">
        <div class="download-box rounded-2xl">
          <div class="bg-lime-500 backdrop-blur-md p-2">
            ...
            >
              ...
              <button type="submit" 
                ...
                class="h-14 px-8 bg-lime-500 hover:from-lime-500 hover:to-lime-400 disabled:from-lime-500 disabled:to-lime-400 text-white font-medium transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed">
                {loading() ? (
                  <>
