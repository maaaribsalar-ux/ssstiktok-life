            ...
            >
              <div class="relative flex-grow rounded bg-gray-200">
                <input type="text"
                  ...
                  placeholder="Insert a TikTok link..."
              ...
              <button type="submit" 
                ...
                class="h-14 px-8 bg-red-600 hover:from-pink-500 hover:to-red-500 disabled:from-red-600 disabled:to-red-500 text-white font-medium rounded shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed">
                {loading() ? (
                  <>
