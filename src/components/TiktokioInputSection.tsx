            ...
            >
              <div class="relative flex-grow rounded bg-pink-50">
                <input type="text"
                  ...
                  class="w-full h-14 border-pink-50 text-black rounded-xl px-5 pr-20 focus:outline-none focus:ring-2 focus:ring-pink-50 focus:border-transparent transition-all duration-300"
                />
                <button type="button" 
                  onClick={handlePaste} 
                  class="absolute right-3 top-1/2 transform -translate-y-1/2 bg-gray-700/80 hover:bg-gray-600 rounded text-white px-4 py-2 transition-all duration-300 flex items-center gap-2">
              ...
              <button type="submit" 
                ...
                class="h-14 px-8 bg-blue-600 hover:blue-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed">
                {loading() ? (
                  <>
