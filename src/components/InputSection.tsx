          ...
          <div class="bg-pink-50 rounded backdrop-blur-md p-2">
            ...
            >
              ...
              <button type="submit" 
                ...
                class="h-14 px-8 bg-indigo-600 hover:from-indigo-600 hover:to-indigo-500 disabled:from-gray-500 disabled:to-gray-400 text-white font-medium rounded hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed">
                {loading() ? (
                  <>
