  ...
  return (
    <div class="max-w-6xl mx-auto mt-8 px-4">
      ...
      <div class="max-w-6xl mx-auto">
        <div class="download-box rounded">
          <div class="bg-pink-50 rounded backdrop-blur-md p-2">
            ...
            >
              <div class="relative flex-grow rounded bg-gray-200">
                ...
                <button type="button" 
                  onClick={handlePaste} 
                  class="absolute right-3 top-1/2 transform -translate-y-1/2 bg-fuchsia-900 hover:fuchsia-900 text-white px-4 py-2 rounded transition-all duration-300 flex items-center gap-2">
              ...
              <button type="submit" 
                ...
                class="h-14 px-8 bg-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-900 disabled:from-fuchsia-600 disabled:to-fuchsia-900 text-white font-medium rounded transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed">
                {loading() ? (
                  <>
